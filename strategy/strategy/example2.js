...
function onTicker() {
    ...
    if (dir == 1) {
       ...
       // if (asset.highPrice <= currentPrice * 0.99) {
        ...
        asset.stopBuyLoss = records[records.length -2].Low
    ...
    if (dir == -1) {
       ...
       // if (asset.lowPrice >= currentPrice * 0.99) {
        ...
        // }
        var records = exchange.GetRecords(PERIOD_H1) //4小时
        asset.stopSellLoss = records[records.length -2].High
...
function calculateStopLoss() {
                      ...
                      if (asset.buyAmount > 0 && asset.stopBuyLoss - 30 > currentPrice) {
                      ...
                      if (asset.sellAmount > 0&& currentPrice > asset.stopSellLoss + 30) {
